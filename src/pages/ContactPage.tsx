...
export default function ContactPage() {
  ...
  return (
    <div className="pt-32 sm:pt-40 min-h-screen bg-bg-dark">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="flex items-center gap-4 sm:gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-lg sm:text-xl font-black tracking-tighter">{settings?.contactEmail || 'contact@oyoung.com'}</p>
                </div>
              </div>
              <div className="flex items-center gap-4 sm:gap-6 group">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full border border-white/10 flex items-center justify-center group-hover:bg-navy group-hover:border-navy transition-all shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-lg sm:text-xl font-black tracking-tighter">{settings?.contactPhone || '02-1234-5678'}</p>
                </div>
              </div>
            </div>
